...
function web_pull() {
    ...
    cd /var/www/web.service/land.transfer                       ; git pull ; echo
    cd /var/www/web.service/land.transfer.admin                 ; git pull ; echo
    cd /var/www/web.service/pcp2fcl_ui                          ; git pull ; echo
    cd /var/www/web.service/gold-web                            ; git pull ; echo
